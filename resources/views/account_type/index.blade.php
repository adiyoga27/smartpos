                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-750">
                        ...
                        <td class="px-4 py-3 text-right">
                            ...
                            <form action="{{ route('account_type.destroy', $type->id ?? 0) }}" method="POST" class="inline">
                                @csrf @method('DELETE')
    ...
    <div x-show="showModal" class="fixed inset-0 z-50 overflow-y-auto" x-transition>
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-md p-6">
                ...
                <form :action="editingId ? '{{ route('account_type.update', '') }}/' + editingId : '{{ route('account_type.store') }}'" method="POST">
                    @csrf
