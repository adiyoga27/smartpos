                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-750">
                        ...
                        <td class="px-4 py-3 text-right">
                            ...
                            <form action="{{ route('expense_category.destroy', $category->id ?? 0) }}" method="POST" class="inline">
                                @csrf @method('DELETE')
    ...
    <div x-show="showModal" class="fixed inset-0 z-50 overflow-y-auto" x-transition>
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-md p-6">
                ...
                <form :action="editingId ? '{{ route('expense_category.update', '') }}/' + editingId : '{{ route('expense_category.store') }}'" method="POST">
                    @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="code" x-model="form.code" required class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 text-sm px-3 py-2 focus:ring-primary-500 focus:border-primary-500">
                        </div>
                    </div>
